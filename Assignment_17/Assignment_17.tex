...
&\\
 & $\implies det\myvec{cI-AB} = det\myvec{cI-BA}$ \\
& \\
\hline
& \\
Proof  & $det\myvec{cI-AB}=det\myvec{I&0\\A&cI-AB}$\\
& $=det \left( \myvec{I&B\\A&cI}\myvec{I&-B\\0&I}  \right)$\\
& $=det\myvec{I&B\\A&cI} det\myvec{I&-B\\0&I}$\\
&\\
& In the above equation $det\myvec{I&-B\\0&I}=1$\\
&\\
& $\implies det\myvec{I&B\\A&cI}=det\myvec{cI-BA&0\\A&I}$\\
& $=det\myvec{cI-BA}$\\
&\\
& Thus, $det\myvec{cI-AB} = det\myvec{cI-BA}$\\
& Hence, $AB$ and $BA$ have precisely the same characteristic values.\\
& \\
\hline
\end{tabular}
}
