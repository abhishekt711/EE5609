...
Thus, Junction Point is (31/17, -2/17), i.e, (1.82,-0.11)
\\
...
(6   -7)\textbf{x} = 8\\
\end{center}
is in the direction of (7,6) as\\
\[(6 , -7).(7,6)=0\]
so the the direction of path he should follow is (7,6)\\
To find the constant c
\[c=(7,6).(31/17,-2/17)=7*\frac{31}{17}+6*\frac{-2}{17}\]
\[c=12.05\]
