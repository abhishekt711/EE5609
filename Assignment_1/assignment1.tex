...
\begin{align}
\myvec{2 & -3}\textbf{x} = 4 \label{eqn1}\\
\myvec{3 & 4}\textbf{x} = 5\label{eqn2}
\end{align}
...
\begin{align}
\myvec{6 & -7}\textbf{x} = 8 \label{eqn6}
\end{align}
normal vector to the given line is:
\begin{align}
\vec{n}=\myvec{0 & -1\\ 1 & 0}\myvec{6 \\ -7}\label{eqn7}\\
\vec{n}=\myvec{7\\6}  \label{eqn8} 
\end{align}
\begin{figure}[htbp]
...
\begin{align}
\vec{n}^T(\vec{x}-\vec{A})=0 \label{eqn9} \\
\vec{n}^T\vec{x}=\vec{n}^T\vec{A} \label{eqn10}
\end{align}
Hence, he should follow this path PQ:
\begin{align}
\myvec{7 & 6} \textbf{x} = \frac{205}{17}\label{eqn11}
\end{align}
