...
\section{Definition}
A matrix $A$ for which $A^H=A$ is said to be a self-adjoint matrix, here conjugate transpose is denoted as $A^H$. If a matrix is self-adjoint, It is said to be hermitian.
\section{solution}
