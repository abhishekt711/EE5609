...
\end{align}
The required system of homogeneous linear equations for which the space of solution is exactly the subspace of subspace of $\mathbb{R}^4$ spanned by the given three vectors are given as:
\begin{align}
