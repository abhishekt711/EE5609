...
A\vec{X}=0
\end{align}
Let $\vec{R}$  be  a echelon matrix which is reduced to  A.  Then  the  systems  $\vec{A}X  =  0$  and  $\vec{R}X  =  0$  have  the  same solutions.
\begin{align}
\implies \myvec{1\\4\\0\\9}=2\myvec{-1\\0\\1\\2}+\myvec{3\\4\\-2\\5}\\
\therefore \alpha_3=2\alpha_1+\alpha_2
\end{align}
...
\begin{align}
\vec{Y}=\myvec{1&0&0\\0&1&0\\-1&\frac{1}{4}&0\\-2&\frac{11}{4}&0}\vec{X}
\end{align}
