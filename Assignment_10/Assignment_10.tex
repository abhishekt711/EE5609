...
%\end{align}
$\rho_1$, $\rho_2$ forms the basis of the solution space. The required homogeneous matrix equation is given as:
\begin{align}
 \myvec{x\\y\\z\\w}= \myvec{1&0\\0&1\\-1&\frac{1}{4}\\-2&\frac{11}{4}}\vec{X}
\end{align}
\end{document}