...
\end{align}
As $\alpha_3$ is dependent of $\alpha_1$ and $\alpha_2$. The system of homogeneous linear equation is spanned by $\alpha_1$ and $\alpha_2$.\\
The required system of homogeneous linear equation are given as:
\begin{align}
\myvec{1&0&0\\0&1&0\\-1&\frac{1}{4}&0\\-2&\frac{11}{4}&0}\myvec{x_1\\x_2\\x_3}
\end{align}
