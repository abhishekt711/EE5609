...
To, find the coordinates of the vector $\myvec{a,b}$ in the ordered basis $\ss=\{\vec{\alpha},\vec{\beta}\}$. 
   \begin{align}
   c_1\myvec{\alpha}+c_2\myvec{\beta}=\myvec{a\\b}\\
   c_1x_1+c_2y_1=a\\
   c_1x_2+c_2y_2=b
   \end{align}
   We can row-reduce the augmented matrix to find the constant $c_1$ and $c_2$,
   \begin{align}
...
\text{Hence,} \nonumber\\
 \myvec{a\\b}&=(ax_1+bx_2)\myvec{\alpha}+(ay_1+by_2)\myvec{\beta}
\end{align}
